    ...
    return (
        <footer className="bg-black lg:grid lg:grid-cols-5 dark:bg-gray-900">
            ...
            <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                ...
                <div>
                    <p>
                    <span className="text-xs uppercase tracking-wide text-white dark:text-white">
                        Call us
                    </span>

                    <a
                        href="#"
                        className="block text-2xl font-medium text-white hover:opacity-75 sm:text-3xl dark:text-white"
                    >
                        9876543210
                    </a>
                    </p>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <p className="mt-8 text-xs text-white sm:mt-0 dark:text-white">
                    &copy; 2024. INVOLVED. All rights reserved.
                    </p>
                </div>
                </div>
            </div>
