...
const NgoCard:React.FC<NgoCardProps> = ({ 
    ...
    return (
       <div className="NgoCard rounded-lg overflow-hidden p-4">
            <div className="mx-auto max-w-sm shadow-xl bg-cover bg-center min-h-150 transform duration-500 hover:-translate-y-2 cursor-pointer group" style={{backgroundImage: `url(${imageUrl})`}}>
